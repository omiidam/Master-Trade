...
| Installer code signing and notarisation, the native updater adapter            | 6.6                 | The packaging gate, the update signing boundary and the update state machine are **implemented** (Phase 6.5, [desktop-release.md](./desktop-release.md)); TDR-20 and TDR-21 are what remain       |
